...
# 工程简介
## 架构拓朴图
![架构拓朴图](http://r.photo.store.qq.com/psb?/V14KUPlZ1oRvxL/.uV7p3Ps89OWEX3sMaWdouY5e4L6HEFyTeuRtqPPMr0!/r/dEMBAAAAAAAA)
## 项目说明
...
> 数据模型：通常是一些实体类映射数据库表，及一些单表基础操作增删改查的接口方法，做为jar包依赖。    
> feign接口：微服务与微服务之间的数据通信，做为jar包依赖，微服务提供者实现接口和微服务消费者调用接口。    
